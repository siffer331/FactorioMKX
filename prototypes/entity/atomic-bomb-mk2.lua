local explosion_animations_mk2 = require("prototypes.entity.demo-explosion-animations-mk2")
...
data:extend({
  ...
  {
    type = "projectile",
    name = "atomic-bomb-wave-spawns-nuke-shockwave-explosion-mk2",
    flags = {"not-on-map"},
    acceleration = 0,
          ...
          {
            {
              ...
              entity_name = "atomic-nuke-shockwave-mk2",
  ...
  {
    type = "projectile",
    name = "atomic-bomb-wave-spawns-nuclear-smoke-mk2",
    flags = {"not-on-map"},
    acceleration = 0,
  ...
  {
    type = "projectile",
    name = "atomic-bomb-wave-spawns-fire-smoke-explosion-mk2",
    flags = {"not-on-map"},
    acceleration = 0,
    speed_modifier = { 1, 0.707 },
    action =
    {
      {
        ...
        action_delivery =
        {
          ...
          target_effects =
          {
            {
              type = "create-explosion",
              entity_name = "atomic-fire-smoke-mk2",
              max_movement_distance = max_nuke_shockwave_movement_distance,
              max_movement_distance_deviation = max_nuke_shockwave_movement_distance_deviation,
              inherit_movement_distance_from_projectile = true,
              cycle_while_moving = true,
  ...
  {
    type = "projectile",
    name = "atomic-bomb-wave-spawns-cluster-nuke-explosion-mk2",
    flags = {"not-on-map"},
    acceleration = 0.1,
    ...
    {
      {
        ...
        action_delivery =
        {
          ...
          target_effects =
          {
            {
              type = "create-entity",
              entity_name = "cluster-nuke-explosion-mk2",
  ...
  {
    type = "explosion",
    name = "atomic-fire-smoke-mk2",
    fade_out_duration = 50,
    scale_out_duration = 100,
  ...
  {
    type = "explosion",
    name = "atomic-nuke-shockwave-mk2",
    ...
    animations = explosion_animations_mk2.nuke_shockwave_mk2(),
  },

  {
    type = "explosion",
    name = "cluster-nuke-explosion-mk2",
        ...
        target_effects =
        {
          ...
          },
          {
            ...
            action =
            {
              ...
              {
                type = "projectile",
                projectile = "atomic-bomb-wave-mk2",
          ...
          },
          {
            ...
            action =
            {
              ...
              {
                type = "projectile",
                projectile = "atomic-bomb-wave-spawns-cluster-nuke-explosion-mk2",
                starting_speed = 0.5 * 0.7,
                starting_speed_deviation = nuke_shockwave_starting_speed_deviation,
              }
            }
          },
          {
            ...
            action =
            {
              ...
              {
                type = "projectile",
                projectile = "atomic-bomb-wave-spawns-fire-smoke-explosion-mk2",
          ...
          },
          {
            ...
            action =
            {
              ...
              {
                type = "projectile",
                projectile = "atomic-bomb-wave-spawns-nuke-shockwave-explosion-mk2",
                starting_speed = 0.5 * 0.65,
                starting_speed_deviation = nuke_shockwave_starting_speed_deviation,
              }
            }
          },
          {
            ...
            action =
            {
              ...
              {
                type = "projectile",
                projectile = "atomic-bomb-wave-spawns-nuclear-smoke-mk2",
                starting_speed = 0.5 * 0.65,
                starting_speed_deviation = nuke_shockwave_starting_speed_deviation,
              }
            }
...
assert(data.raw["projectile"]["atomic-bomb-wave-mk2"])
